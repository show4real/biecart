...
Route::group(['prefix'=>'admin-home'],function() {
    Route::controller(BlogController::class)->prefix('landlord-blog')->name('landlord.')->middleware(['adminglobalVariable','auth:admin', 'set_lang'])->group(function () {
...
if (is_null(tenant())){
    Route::controller(\Modules\Blog\Http\Controllers\Landlord\Frontend\BlogController::class)->prefix('landlord-blog')->name('landlord.')->middleware(['landlord_glvar','maintenance_mode', 'set_lang'])->group(function (){
