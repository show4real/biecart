...
--
-- Host: localhost:3306
-- Generation Time: Aug 17, 2023 at 07:06 PM
...
CREATE TABLE `cronjob_logs` (
  ...
  `running_qty` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'English (UK)', 'en_GB', 0, 1, 1, '2022-02-01 06:25:48', '2023-01-22 17:50:06'),
(3, 'العربية', 'ar', 1, 1, 0, '2022-02-01 06:34:28', '2023-01-22 17:50:05');
...
(256, 'no-image.jpg', 'no-image1672896265.jpg', NULL, '19.5 KB', 0, 10, '1000 x 1000 pixels', '2023-01-05 05:24:26', '2023-01-05 05:24:26'),
(258, '11.png', '111674914359.png', NULL, '245.47 KB', 0, 10, '605 x 611 pixels', '2023-01-28 13:59:20', '2023-01-28 13:59:20'),
(259, 'avatar-g807878a30_1280.png', 'avatar-g807878a30-12801675576791.png', NULL, '97.91 KB', 0, 10, '1280 x 1179 pixels', '2023-02-05 05:59:52', '2023-02-05 05:59:52'),
(260, 'V0V5TjLD_400x400.jpg', 'v0v5tjld-400x4001675641515.jpg', NULL, '18.87 KB', 0, 10, '258 x 258 pixels', '2023-02-05 23:58:36', '2023-02-05 23:58:36'),
(261, 'Capture.JPG', 'capture1676251744.jpg', NULL, '44.38 KB', 0, 10, '1340 x 797 pixels', '2023-02-13 01:29:04', '2023-02-13 01:29:04'),
(262, 'order-20220912-10085522.pdf', 'order-20220912-100855221677487656.pdf', NULL, NULL, 0, 10, NULL, '2023-02-27 08:47:36', '2023-02-27 08:47:36'),
(263, 'wallpaperflare.com_wallpaper (2).jpg', 'wallpaperflarecom-wallpaper-21678492740.jpg', NULL, '267.86 KB', 0, 10, '1920 x 1080 pixels', '2023-03-10 23:59:01', '2023-03-10 23:59:01'),
(264, 'LOGO JPG 3.jpg', 'logo-jpg-31678530746.jpg', NULL, '1.14 MB', 0, 10, '3000 x 3000 pixels', '2023-03-11 10:32:28', '2023-03-11 10:32:28'),
(265, 'title-line-shapes.png', 'title-line-shapes1678858014.png', NULL, '1.41 KB', 0, 10, '449 x 38 pixels', '2023-03-15 05:26:54', '2023-03-15 05:26:54'),
(266, 'wstlogo.png', 'wstlogo1679159118.png', NULL, '128.96 KB', 0, 10, '3395 x 2464 pixels', '2023-03-18 17:05:20', '2023-03-18 17:05:20'),
(267, 'pexels-photo-14819864.jpeg', 'pexels-photo-148198641682568180.jpg', NULL, '38.52 KB', 0, 10, '500 x 625 pixels', '2023-04-27 04:03:00', '2023-04-27 04:03:00'),
(268, 'cleaning.png', 'cleaning1685465083.png', NULL, '22.48 KB', 0, 10, '512 x 512 pixels', '2023-05-30 16:44:44', '2023-05-30 16:44:44'),
(269, 'pngtree-cash-on-delivery-pin-point-png-image_6331307.jpg', 'pngtree-cash-on-delivery-pin-point-png-image-63313071688118203.jpg', NULL, '195.81 KB', 0, 10, '1200 x 1200 pixels', '2023-06-30 09:43:23', '2023-06-30 09:43:23'),
(270, 'A5JUfEhcFuj9oKVsB5Jr0ZKeWpjPRA1Uy94pKi2i.png', 'a5jufehcfuj9okvsb5jr0zkewpjpra1uy94pki2i1688772624.png', NULL, '194.04 KB', 0, 10, '484 x 604 pixels', '2023-07-07 23:30:25', '2023-07-07 23:30:25'),
(271, '123.txt', '1231688772685.png', NULL, '194.04 KB', 0, 10, '484 x 604 pixels', '2023-07-07 23:31:25', '2023-07-07 23:31:25'),
(272, 'OBJECTS.svg', 'objects1689759728.svg', NULL, NULL, 0, 10, NULL, '2023-07-19 09:42:08', '2023-07-19 09:42:08');
...
CREATE TABLE `plan_payment_gateways` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `plan_id` bigint(20) NOT NULL,
  `payment_gateway_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(5, 'get_script_version', '1.2.0', NULL, '2022-06-15 06:45:51', '2023-08-17 12:12:58'),
...
(32, 'bookpoint_theme_name', 'BookPoint', 'c8de72b2-e6bb-4c7f-b70c-b48f5bca8566', '2023-05-02 06:48:41', '2023-05-02 06:48:41'),
...
CREATE TABLE `tenant_unique_keys` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `tenant_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unique_key` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `xg_ftp_infos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `item_version` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item_license_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item_license_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item_license_msg` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
